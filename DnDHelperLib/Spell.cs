...
{4}", Name, ConvertTypesToString(), Level.ToString(), ConvertToString(SpellShool), Description, ConvertToString(Range), Duration);
    ...
    public enum SpellType { All, Mage, Cleric, Druid, Ranger, Paladin, Bard };
    public enum SpellShool { Conjuration, Illusion, Necromancy, Abjuration, Enchantment, Transmutation, Divination, Summoning };
